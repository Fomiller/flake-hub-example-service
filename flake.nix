{
  inputs = {
    ...
    golden-base.url = "github:Fomiller/flake-hub?dir=golden-base&ref=refs/tags/golden-base-0.4.0";
    golden-base.inputs.nixpkgs.follows = "nixpkgs";
    golden-base.inputs.golden-engine.follows = "golden-engine";
    golden-github.url = "github:Fomiller/flake-hub?dir=golden-github&ref=refs/tags/golden-github-0.4.0";
    golden-github.inputs.nixpkgs.follows = "nixpkgs";
    golden-github.inputs.golden-engine.follows = "golden-engine";
    golden-service.url = "github:Fomiller/flake-hub?dir=golden-service&ref=refs/tags/golden-service-0.4.0";
    golden-service.inputs.nixpkgs.follows = "nixpkgs";
    golden-service.inputs.golden-engine.follows = "golden-engine";
    golden-infra.url = "github:Fomiller/flake-hub?dir=golden-infra&ref=refs/tags/golden-infra-0.2.0";
    golden-infra.inputs.nixpkgs.follows = "nixpkgs";
    golden-infra.inputs.golden-engine.follows = "golden-engine";
    golden-argocd.url = "github:Fomiller/flake-hub?dir=golden-argocd&ref=refs/tags/golden-argocd-0.4.0";
